...
namespace chess
{
    ...
    // I THINK IT'S A PROBLEM HERE. THIS WAS ALL ERROR SO I SEPARATED OUT
    // LINES 270 - 277 from the instantation on 279, I think there's
    // a version error

    const Bitboard bb_blank_tmp = 0x0101'0101'0101'0101ULL;
